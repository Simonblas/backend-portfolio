...
public class InitialDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (userService.getAllUsers().isEmpty()) {
            ...
            // CREDENCIALES DE ACCESO (Necesario para Spring Security) ---
